          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800/80 pt-6 md:pt-0 md:pl-8 space-y-4">
              ...
              <button
                ...
                className="w-full my-10 py-2.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 text-xs font-semibold rounded-xl shadow-sm transition-all flex items-center justify-center space-x-2 cursor-pointer"
              >
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                <span className="text-[10px] font-mono font-bold tracking-wider uppercase text-slate-400 dark:text-slate-500 whitespace-nowrap">
                  {isSignUp ? 'Create Civic Account' : 'Standard Email Login'}
                </span>
                <span className="h-px flex-1 bg-slate-200 dark:bg-slate-800" />
              </div>
